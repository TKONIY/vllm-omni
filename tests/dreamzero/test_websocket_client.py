...
Tests that vllm-omni's /v1/world/roboarena endpoint is protocol-compatible
with DreamZero's test_client_AR.py. Run against a live server.

Usage:
    python tests/dreamzero/test_websocket_client.py --url ws://localhost:8000/v1/world/roboarena
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", default="ws://localhost:8000/v1/world/roboarena")
