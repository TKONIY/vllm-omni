...
Usage:
    PYTHONPATH=/home/yangshen/code/dreamzero \\
      ...
      tests/dreamzero/upstream_socket_server_no_compile.py --port 18081 \\
...
import tyro
import socket_test_optimized_AR as upstream
from groot.vla.model.dreamzero.modules import attention as upstream_attention
from groot.vla.model.dreamzero.modules import wan2_1_submodule as upstream_submodule
