...
def test_step2_scheduler_marks_dit_phase_as_dit_work_not_ar_decode() -> None:
    ...
    assert len(scheduler_output.scheduled_items) == 1
    item = scheduler_output.scheduled_items[0]
    assert item.phase == "dit_step"
